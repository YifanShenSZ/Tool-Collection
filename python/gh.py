...
def parse_args() -> argparse.Namespace: # Command line input
    ...
    parser.add_argument('-go','--goutput', type=Path, default='g.cart', help='g output file (default = g.cart)')
    parser.add_argument('-ho','--houtput', type=Path, default='h.cart', help='h output file (default = h.cart)')
